...
Clone this repository on to your system and make sure you are in the same directory in terminal.
Run npm install to download any missing dependencies in your system.
Now run the server by the command npm run start .
It will start on localhost.
Open localhost in your browser and see the working .
